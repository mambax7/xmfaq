...
switch ($op) {
    ...
    default:
        ...
        $question_arr   = $questionHandler->getByLink($criteria);
    ...
    case 'view':
        ...
        $question_arr = array(
            _AM_XMFAQ_QUESTION_TITLE  => $question->getVar('question_title'),
    ...
    case 'edit':
        ...
        // Create form
        $obj  = $questionHandler->get(XoopsRequest::getInt('question_id', 0));
        $form = $obj->getForm();
        // Assign form
        $xoopsTpl->assign('form', $form->render());
        break;
    ...
    case 'del':
        ...
        if (isset($_POST['ok']) && $_POST['ok'] == 1) {
            ...
            xoops_confirm(array(
                              ...
                              'op'          => 'del'
                          ), $_SERVER['REQUEST_URI'], sprintf(_AM_XMFAQ_QUESTION_SUREDEL, $obj->getVar('question_title')));
        }
        break;
    // save question
    case 'save':
